...
def draw_comparison_dashboard(bert_probabilities, lr_probabilities, bert_pred, lr_pred):
    """
    Generates 4 distinct visualization charts comparing the performance,
    confidence distributions, and variance between the two models.
    """
    ...
    # Combined Dataframe for joint charts
    df_combined = pd.concat([df_bert, df_lr])

    # ----------------------------------------------------
    # CHART 1 & 2: Two individual horizontal confidence charts side-by-side
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # CHART 3: Model Target Comparison (Side-by-Side Bar Chart)
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # CHART 4: Top Prediction Confidence Gauge Comparison
    # ----------------------------------------------------
    with col4:
